...
public class LSAFixed  {
	private static final Logger logger = Logger.getLogger(LSA.class.getCanonicalName());
	   ...
	   * @throws IOException 
	   */
	  private LSAFixed(String luceneIndexDir, FlagConfig flagConfig) throws IOException {
	  ...
	  private SMat smatFromIndex() throws IOException {
	    ...
	    VerbatimLogger.info(String.format(
	        "There are %d terms (and %d docs).\n", tc, this.luceneUtils.getNumDocs()));
	    termList = new String[tc];
	    int[][] baseIndex = new int[tc][];
	  ...
	  public static void main(String[] args) throws IllegalArgumentException, IOException {
	    ...
	    LSAFixed lsaIndexer = new LSAFixed(flagConfig.luceneindexpath(), flagConfig);
